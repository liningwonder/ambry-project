 ...
 *
 * To track state of replica that is catching up or being commissioned, this class leverages a {@link CountDownLatch}.
...
public class AmbryReplicaSyncUpManager implements ReplicaSyncUpManager {
  ...
  /**
   * {@inheritDoc}
   * The method is blocked on a {@link CountDownLatch} until the bootstrap is complete
   */
  @Override
