...
public class BlobIdTransformer implements Transformer {
   ...
   */
  private MessageHeader_Format getMessageHeader(InputStream stream)
    ...
    switch (headerVersion) {
      case Message_Header_Version_V1:
        headerBuf = ByteBuffer.allocate(MessageHeader_Format_V1.getHeaderSize());
      ...
      case Message_Header_Version_V2:
        headerBuf = ByteBuffer.allocate(MessageHeader_Format_V2.getHeaderSize());
        headerBuf.putShort(headerVersion);
        inputStream.read(headerBuf.array(), Version_Field_Size_In_Bytes,
      ...
      case Message_Header_Version_V3:
        headerBuf = ByteBuffer.allocate(MessageHeader_Format_V3.getHeaderSize());
        headerBuf.putShort(headerVersion);
        inputStream.read(headerBuf.array(), Version_Field_Size_In_Bytes,
