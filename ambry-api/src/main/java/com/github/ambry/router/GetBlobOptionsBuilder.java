 ...
 * {@link OperationType#All}, {@link GetOption#None} and no {@link ByteRange}.
 */
public class GetBlobOptionsBuilder {
  ...
  /**
   * @param operationType the {@link OperationType} for this request.
   * @return this builder
   */
  public GetBlobOptionsBuilder operationType(OperationType operationType) {
